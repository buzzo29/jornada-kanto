...
function createSandbox(htmlPath){
  ...
  const EXPORTS = [
    ...
    'especieNoNivel','rollWildLevel','EVOLVED_MIN_LEVEL','SEM_PISO_DE_NIVEL','nivelSelvagem','GOLPES','GOLPES_IDS','GOLPES_PT','APRENDIZADO','ataquesDisponiveis','ataquesEscolhiveis','ataquesPadrao','nomeDoAtaque','nivelDoAtaque','melhorAtaque','hydrateTeam','hydrateTeamMember','escolhasDeAtaquePendentes','resolverEscolhaDeAtaques','marcarAtaque','confirmarAtaques','aprendizadosPendentes','resolverAprendizados','responderAprendizado','renderEscolhaDeAtaques','renderAprenderAtaque','renderGolpeAprendido','anunciarGolpesAprendidos','seguirDoGolpeAprendido','aprendizadosPendentes','resolverAprendizados','responderAprendizado','ataquesDisponiveis','ataquesPadrao','melhorAtaque','golpesDoTimeHtml','golpesDaEvolucao','nivelDoAtaque','nomeDoAtaque','APRENDIZADO','GOLPES','GOLPES_IDS','GOLPES_PT','especiaisDaEspecie','cartaoDeGolpe','seloDoTipoDoGolpe','TYPE_COLORS','startLevelDistribution','continueFromEvolution','chooseStarter',
    ...
    'AUTODESTRUICAO','SONIFEROS','MULTI_GOLPE','METRONOMO','DANCA_ESPADAS','DANCA_PLUMA','CHANCE_DANCA','DANCA_ESPADAS_MULT','DANCA_PLUMA_MULT','withDanca','tentarDancas','fighterHtml','selosDoConfronto','pontoFinal','REVIDE_PISO_MIN','REVIDE_PISO_MAX','MORIBUNDO_ABAIXO_DE','MORIBUNDO_TETO_NO_CHEIO','tentarDancas','trocaDoRemoinho','CONFUSAO','CHANCE_CONFUSAO','FURIA_DRAGAO','CHUVA','CHANCE_CHUVA','CHUVA_EM_CONFRONTOS','CHUVA_MULT','CHUVA_GOLPE_MULT','estaChovendo','multDaChuva','tentarChuva','limparClima','CHANCE_FURIA_DRAGAO','FURIA_DRAGAO_DANO','sorteiaGolpeDoMetronomo','POOL_METRONOMO','FURIA','CHANCE_FURIA','FURIA_BONUS','withFuria','obsDoGolpe','registrarSketch','ehJornada','finishNeighborhoodGymBattle','aprendizadosPendentes','usaSketch','renderMatchupLog','chuvaBadgeHtml','GOLPES_CRIT_ALTO','chanceDeCritico','CRIT_BASE','CRIT_ALTO','CRIT_MULT','corDoGolpe','TYPE_COLORS','MAX_GOLPES','equiparNpc','ataquesDisponiveis','tentarGolpeEspecial','tapasDoGolpe','poderEfetivo','passosHtml','DMG_CAP_PCT','TETO_GOLPES','GOLPES_DRENO','GOLPES_SO_DORMINDO','melhorAtaque','METRONOMO','tentarGolpeEspecial','sorteiaGolpeEspecial','tipoDoGolpe','passosHtml','CHANCE_AUTODESTRUICAO','CHANCE_SONO','SONO_EM_TROCAS','sorteiaTrocasDeSono','DISABLE','CHANCE_RECUPERAR','RECUPERACAO','ABSORCAO','MOEDAS_RESSORTEIO','MAX_RESSORTEIOS_POR_SAVE','ressorteiosRestantes','precoDoRessorteio','bonusShinyAtivo','MOEDA_MODO_DIFICIL','HARD_SHINY_CHANCE','SHINY_CHANCE','currentShinyChance','pickGameMode','renderNewSaveMode','renderNewSaveName','CHANCE_ABSORVER','ABSORVER_MIN','ABSORVER_MAX','CURA_MAXIMO_DO_HP','CHANCE_DISABLE','tiposDeAtaque','ehDittoTransformado','tiposProprios','bestAttackType','avisoDoConfronto','SPECIALTY_BUFF','buildAnimatedHitSequence','pausaDoNomeDoGolpe','hpBarTransitionMs','ORCAMENTO_ANIM_ONLINE_MS','statusDoConfronto','statusDoConfrontoHtml','fraseDoGolpeUsado','pintarStatusDoConfronto','pausaDaCura','avisoDaCura','towerEligiblePokemon','gymChallengeTogglePick','montadorDeTimeHtml','renderTrainerTower','ITENS','HMS','hmsDaConta','temHM','darHM','conquistouHM01','HM01_ROTA','HM01_GINASIO','MOSTRAR_TM_HM','abrirTmHm','sairDoTmHm','renderTmHm','CORTADORES','GOLPE_DO_CORTE','podeAprenderCorte','sabeCortar','timeQueCorta','ehOSlotAberto','timeDoSlot','candidatosDaMaquina','nomeDoSave','abrirEnsinarHm','sairDoEnsinarHm','voltarDaTrocaDaMaquina','escolherAlvoDaMaquina','ensinarOGolpeDaMaquina','renderHmAlvo','renderHmTroca','timesDaMaquina','abrirTimeDaMaquina','voltarAosTimesDaMaquina','telaDosTimesDaMaquina','telaDoTimeDaMaquina','ehGolpeDeMaquina','ataquesTrocaveis','responderAprendizado','renderAprenderAtaque','kantoMapSvg','renderKantoMapScreen','tryEvolve','ataquesEscolhiveis','cortadorDoTime','ROTA_DO_CORTE','CHANCE_ROTA_DO_CORTE','ROTA_DO_CORTE_A_PARTIR_DE','temRotaDoCorte','cartasDeRota','chooseRoute','renderRouteCardsBlock','routesForLeg','routeById','montarAVigilia','entrarNaMataFechada','renderMataFechada','moverNaVigilia','GOLPE_ROLAMENTO','ROLAMENTO_USOS','escalaDoRolamento','atualizarRolamento','SINO_CURATIVO','CHANCE_SINO','definirClima','climaRestante','pontuada','passosDaAbertura','calcDamage','ataquesPadrao','comecarAVigilia','escolherOPremioDaVigilia','renderVigiliaPremio','VIGILIA_TAMANHO','VIGILIA_SHINIES','VIGILIA_ABAIXO','startSpecialBattle','runSpecialBattle','finishSpecialBattle','continueAfterSpecial','advanceSpecialReveal','SAFE_SAVE_SCREENS','raizDaLinha','ehLendario','especieNoNivel','LEGS','serializeGame','applySavedState','hmGanhoHtml','openInventario','sairDaMochila','ctaDaNotificacao','pedirExclusaoDeItem','pilhasDoInventario','cuponsDeBonusShiny','slotsDaGrade','renderInventario','botaoDeItemHtml','renderTeamOrder','renderTowerOrderModal','abrirEscolhaDeItem','fecharEscolhaDeItem','renderEscolhaDeItemModal','renderLoja','LOJA_PRATELEIRAS','itensDaPrateleira','prateleiraDoItem','escolherPrateleira','quantoTenho','quantoPossoVender','precoDeVenda','abrirVenda','venderItem','tetoDoPopup','VENDA_FRACAO','maximoQueCabe','abrirCompra','fecharCompra','mudarQtdCompra','qtdCompraMax','renderCompraModal','comprarItem','escolherItem','escolherItemDaLoja','openLoja','podeExcluir','motivoDeNaoExcluir','openCandyPicker','renderCandyPickerModal','renderSaveSelect','startNewSave','continueSave','continueCompleteSave','exigeNomeDeTreinador','confirmAccountSetup','renderAccountSetup','savesCampeoes','exigeTimeCampeao','AVISO_SEM_CAMPEAO','openLeagueTypesList','openNeighborhoodGymScreen','openOnlineBattle','openSaveSelect','MAX_SAVE_SLOTS','gradeDeItensHtml','INVENTARIO_SLOTS_MINIMOS','montadorIrPara','montadorPaginaValida','MONT_POR_PAGINA','montadorOrdenar','montadorFiltrarTipo','montadorOrdenados','montadorTiposDisponiveis','abrirMontador','MONT_ORDENS','towerTogglePick','gymDefenseTogglePick','renderNeighborhoodGymTeamPicker','alternarEscolhaDeTime','chaveDoPokemon','esperaDosPokemon','renderNeighborhoodGymChallengeTeamPicker','startNeighborhoodGymChallenge','golpeSeloHtml','especiaisDaEspecie','TIPO_DO_ESPECIAL','EXPLICACAO_DO_ESPECIAL','textoDoEspecial','abrirEspecialInfo','fecharEspecialInfo','renderEspecialInfoModal','seloDeGolpe','openOnlineBattle','carregarHistoricoOnline','renderOnlineBattle','renderPokedexFicha','golpesDoItem','tiposDeAtaqueDaEspecie','listaEmPortugues','itemServeNoPokemon','nomeDoGolpe','abrirPokedexFicha','SPECIES_FORA_DA_DEX','PRAZO_HISTORICO_MS','sequenciaDoConfronto','pausaDoEspecial','pausaDaFaixa','PAUSA_LEITURA_ESPECIAL_MS','fraseDoEspecial','calcMaxHp','makeSeededRng','simulateGymBattle','createInstance',
    // o salvamento: o ciclo do _especialContra ja custou save de jogador (ver test-especiais.js)
    'limparParaFirestore','serializeGame','encerrarBatalha','placarDoTreinador','renderTowerRankingModal','openTowerRanking','abrirHistoricoDaTorre','abrirHojeDaTorre','closeTowerRanking','renderHpBar','renderTerrainInfoModal','abrirConfronto','game','hydrateTeam',
