...
function createSandbox(htmlPath){
  ...
  const EXPORTS = [
    ...
    'AUTODESTRUICAO','SONIFEROS','METRONOMO','tentarGolpeEspecial','sorteiaGolpeEspecial','tipoDoGolpe','passosHtml','CHANCE_AUTODESTRUICAO','CHANCE_SONO','DISABLE','CHANCE_DISABLE','tiposDeAtaque','ehDittoTransformado','tiposProprios','bestAttackType','avisoDoConfronto','openOnlineBattle','carregarHistoricoOnline','renderOnlineBattle','renderPokedexFicha','abrirPokedexFicha','SPECIES_FORA_DA_DEX','PRAZO_HISTORICO_MS','sequenciaDoConfronto','pausaDoEspecial','fraseDoEspecial','calcMaxHp','makeSeededRng','simulateGymBattle','createInstance',
