...
function createSandbox(htmlPath){
  ...
  const EXPORTS = [
    ...
    'QUEIMADA_BOLA_V_DEVOLVIDA','queimadaCorDaCauda','QUEIMADA_CAUDA_FUNDO','QUEIMADA_CONTORNO_BOLA','QUEIMADA_REFLEXO_MULT','QUEIMADA_REFLEXO_TETO',
