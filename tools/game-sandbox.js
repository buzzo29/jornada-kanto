...
function createSandbox(htmlPath){
  ...
  const EXPORTS = [
    ...
    'AUTODESTRUICAO','SONIFEROS','MULTI_GOLPE','METRONOMO','CONFUSAO','CHANCE_CONFUSAO','sorteiaGolpeDoMetronomo','POOL_METRONOMO','FURIA','CHANCE_FURIA','FURIA_BONUS','withFuria','obsDoGolpe','registrarSketch','aprendizadosPendentes','usaSketch','renderMatchupLog','GOLPES_CRIT_ALTO','chanceDeCritico','CRIT_BASE','CRIT_ALTO','CRIT_MULT','corDoGolpe','TYPE_COLORS','MAX_GOLPES','equiparNpc','ataquesDisponiveis','tentarGolpeEspecial','tapasDoGolpe','poderEfetivo','passosHtml','DMG_CAP_PCT','TETO_GOLPES','METRONOMO','tentarGolpeEspecial','sorteiaGolpeEspecial','tipoDoGolpe','passosHtml','CHANCE_AUTODESTRUICAO','CHANCE_SONO','SONO_EM_TROCAS','DISABLE','CHANCE_RECUPERAR','RECUPERACAO','ABSORCAO','MOEDAS_RESSORTEIO','precoDoRessorteio','bonusShinyAtivo','MOEDA_MODO_DIFICIL','HARD_SHINY_CHANCE','SHINY_CHANCE','currentShinyChance','pickGameMode','renderNewSaveMode','renderNewSaveName','CHANCE_ABSORVER','ABSORVER_MIN','ABSORVER_MAX','CHANCE_DISABLE','tiposDeAtaque','ehDittoTransformado','tiposProprios','bestAttackType','avisoDoConfronto','SPECIALTY_BUFF','buildAnimatedHitSequence','pausaDoNomeDoGolpe','hpBarTransitionMs','ORCAMENTO_ANIM_ONLINE_MS','statusDoConfronto','statusDoConfrontoHtml','fraseDoGolpeUsado','pintarStatusDoConfronto','pausaDaCura','avisoDaCura','towerEligiblePokemon','gymChallengeTogglePick','montadorDeTimeHtml','renderTrainerTower','ITENS','openInventario','sairDaMochila','ctaDaNotificacao','pedirExclusaoDeItem','pilhasDoInventario','cuponsDeBonusShiny','slotsDaGrade','renderInventario','botaoDeItemHtml','renderTeamOrder','renderTowerOrderModal','abrirEscolhaDeItem','fecharEscolhaDeItem','renderEscolhaDeItemModal','renderLoja','quantoTenho','maximoQueCabe','abrirCompra','fecharCompra','mudarQtdCompra','qtdCompraMax','renderCompraModal','comprarItem','escolherItem','escolherItemDaLoja','openLoja','podeExcluir','motivoDeNaoExcluir','openCandyPicker','renderCandyPickerModal','renderSaveSelect','gradeDeItensHtml','INVENTARIO_SLOTS_MINIMOS','montadorIrPara','montadorPaginaValida','MONT_POR_PAGINA','montadorOrdenar','montadorFiltrarTipo','montadorOrdenados','montadorTiposDisponiveis','abrirMontador','MONT_ORDENS','towerTogglePick','gymDefenseTogglePick','renderNeighborhoodGymTeamPicker','alternarEscolhaDeTime','chaveDoPokemon','esperaDosPokemon','renderNeighborhoodGymChallengeTeamPicker','startNeighborhoodGymChallenge','golpeSeloHtml','especiaisDaEspecie','TIPO_DO_ESPECIAL','seloDeGolpe','openOnlineBattle','carregarHistoricoOnline','renderOnlineBattle','renderPokedexFicha','golpesDoItem','tiposDeAtaqueDaEspecie','listaEmPortugues','itemServeNoPokemon','nomeDoGolpe','abrirPokedexFicha','SPECIES_FORA_DA_DEX','PRAZO_HISTORICO_MS','sequenciaDoConfronto','pausaDoEspecial','pausaDaFaixa','PAUSA_LEITURA_ESPECIAL_MS','fraseDoEspecial','calcMaxHp','makeSeededRng','simulateGymBattle','createInstance',
